    ...
    public void run(){
        ...
        try{
            ...
            if(data.containsKey(city))
            {
                ...
                //cerere http, client http pentru cerere -> pentru a obtine info, http get
                ...
                if(false)
                {
                    ...
                    HttpGet httpGet = new HttpGet(Constants.WEB_SERVICE_ADDRESS +
                                                 "?q=" + city + "&APPID=" + Constants.WEB_SERVICE_API_KEY +
                ...
                if(false)
                {
                    ...
                    Element element = (Element) document.child(0);
                    Elements elements = (Elements) element.getElementsByTagName(Constants.SCRIPT_TAG);
                    for(org.jsoup.nodes.Element script : elements){
